...
static config_t cfg_ov5640_init[] =
{
...
int init_ov5640(e_resolution resolution)
{
	...
	case RESOLUTION_320_200:
		cfg = cfg_ov5640_init_640_480_30;
		num_cmds = sizeof(cfg_ov5640_init_640_480_30) / sizeof(cfg_ov5640_init_640_480_30[0]);
		break;
	...
	case RESOLUTION_960_540:
		cfg = cfg_ov5640_init_1920_1080_30;
		num_cmds = sizeof(cfg_ov5640_init_1920_1080_30) / sizeof(cfg_ov5640_init_1920_1080_30[0]);
		break;
	default:
		break;
	}
