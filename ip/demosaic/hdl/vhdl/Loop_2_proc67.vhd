...
architecture behav of Loop_2_proc67 is 
    ...
    signal p_odata_V_data_V_1_data_out : STD_LOGIC_VECTOR (23 downto 0);
    ...
    signal i_0_i1_reg_124 : STD_LOGIC_VECTOR (18 downto 0);
    ...
    signal i_fu_141_p2 : STD_LOGIC_VECTOR (18 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_i1_fu_135_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                ...
                i_0_i1_reg_124 <= ap_const_lv19_0;
            end if; 
        end if;
    end process;
    process (ap_clk)
    ...
    exitcond_i1_fu_135_p2 <= "1" when (i_0_i1_reg_124 = ap_const_lv19_4B000) else "0";
    i_fu_141_p2 <= std_logic_vector(unsigned(i_0_i1_reg_124) + unsigned(ap_const_lv19_1));
